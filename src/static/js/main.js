$(function() {
  ...
  // ]
  var videoArr = ['https://fast.alilo.com.cn/Upload/Video/2019/07/18/g6.mp4',
    'https://fast.alilo.com.cn/Upload/Video/2019/07/18/p1.mp4',
    'https://fast.alilo.com.cn/Upload/Video/2019/07/18/m7.mp4'
  ]
  ...
  // 视频点击播放
  $("#homeVideo").on("click", ".home-video-mode-img,.home-video-mode-tetle", function() {
    ...
    videojs("my-video").ready(function() {
      ...
      if (id == 1) {
        ...
        var videoText = "G6 Honey Bunny"
      } else if (id == 2) {
        var videoUrl = videoArr[1];
        var videoText = "alilo Smarty shake & tell rattles R1"
      } else if (id == 3) {
        var videoUrl = videoArr[2];
        var videoText = "alilo Explorer STEM programming robot M7"
      }
      $("#my-video source").attr("src", videoUrl);
      $("#videoTetle").html(videoText);
